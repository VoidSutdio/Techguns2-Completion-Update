...
public interface INpcTGDamageSystem {
    float getTotalArmorAgainstType(TGDamageSource dmgsrc);

    float getPenetrationResistance(TGDamageSource dmgsrc);
     ...
     * @return
     */
    default float getToughnessAfterPentration(EntityLivingBase elb, TGDamageSource src) {
