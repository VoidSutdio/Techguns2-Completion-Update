...
public class RecipeJsonConverter {
    ...
    private static final HashMap<String, String> recipe_types = new HashMap<>();
    ...
    public static void addShapedRecipe(ItemStack result, Object... components) {
        ...
        if (result.getItem() instanceof GenericItemShared) {
            suffix.append("_").append(TGItems.SHARED_ITEM.get(result.getItemDamage()).getName());
        }
        if (result.getItem() instanceof ItemBlock ib) {

            Block b = ib.getBlock();

            if (b instanceof BasicMachine bm) {
                suffix.append("_").append(bm.getNameSuffix(result.getMetadata()));
            }
        }
    ...
    public static void addShapelessAmmoSwapRecipe(GenericGun gun, AmmoType type, String key) {
        ...
        StringBuilder suffix = new StringBuilder("_ammo_" + key);
    ...
    public static void addShapelessMiningHeadUpgradeRecipe(GenericGun gun, ItemStack upgradeItem, String key, int value) {
        ...
        StringBuilder suffix = new StringBuilder("_upgrade_" + upgradeItem.getItem().getTranslationKey());
    ...
    public static void addShapedCopyNBTRecipe(ItemStack result, Object... components) {
        addShapedRecipeSpecialType(result, new ResourceLocation(Tags.MOD_ID, ShapedOreRecipeCopyNBTFactory.COPY_NBT_RECIPE), components);
    }

    public static void addShapedAmmoSumRecipe(ItemStack result, Object... components) {
        addShapedRecipeSpecialType(result, new ResourceLocation(Tags.MOD_ID, AmmoSumRecipeFactory.AMMO_SUM_RECIPE), components);
    }
