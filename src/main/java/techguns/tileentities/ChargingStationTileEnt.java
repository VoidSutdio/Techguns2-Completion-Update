...
public class ChargingStationTileEnt extends BasicMachineTileEnt {
    ...
    public ChargingStationTileEnt() {
        ...
        this.inventory = new ItemStackHandlerPlus(3) {
            ...
            protected boolean allowItemInSlot(int slot, ItemStack stack) {
                return switch (slot) {
                    case SLOT_INPUT -> isItemValidForSlot(slot, stack);
    ...
    public ITextComponent getDisplayName() {
        return new TextComponentTranslation(Tags.MOD_ID + ".container.chargingstation");
    }
    ...
    @Override
    protected SimpleMachine<EnumSimpleMachineType> getMachineBlockType() {
