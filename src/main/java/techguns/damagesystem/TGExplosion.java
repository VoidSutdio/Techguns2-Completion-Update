...
public class TGExplosion {
    ...
    public void doExplosion(boolean playSound) {
        ...
        for (Entity entity : list) {
            ...
            if (!entity.isImmuneToExplosions() && GenericProjectile.BULLET_TARGETS.test(entity)) {
                ...
                if (distance <= primaryRadius) damage = primaryDamage;
                    ...
                    damage = secondaryDamage + ((distance - primaryRadius) / (secondaryRadius - primaryRadius)) * (primaryDamage - secondaryDamage);
                else damage = 0.0;
