...
public class BlockUtils {
    ...
    public static String getBlockStateVariantString(IBlockState state) {
        ...
        COMMA_JOINER.appendTo(sb, state.getProperties().entrySet().stream().map(MAP_ENTRY_TO_STRING).collect(Collectors.toList()));
        return sb.toString();
    }

    public static void rotateAroundY(MutableBlockPos pos, BlockPos axis, int steps) {
    ...
    public static void rotateAroundY(MutableBlockPos pos, Vec3d axis, int steps) {
