...
public class TemplateSegment {
    ...
    static {
        boolean t = true;
        boolean f = false;
        addSegment(SegmentType.STRAIGHT, 0, 0, new boolean[]{f, f, f, t, f, f, f, t}, 2);
        addSegment(SegmentType.CURVE, 0, 1, new boolean[]{f, f, f, t, f, t, f, f}, 4);
        addSegment(SegmentType.FORK, 0, 2, new boolean[]{f, f, f, t, f, t, f, t}, 4);
        addSegment(SegmentType.CROSS, 0, 3, new boolean[]{f, t, f, t, f, t, f, t}, 1);
        addSegment(SegmentType.END, 0, 4, new boolean[]{f, f, f, t, f, f, f, f}, 4);

        addSegment(SegmentType.RAMP, 1, 0, 2); // new boolean[]{f,f,f, t, f, f, f, t}, 4); //sizeY = 2
        addSegment(SegmentType.ENTRANCE, 1, 1, 1);

        addSegment(SegmentType.ROOM_WALL, 2, 0, new boolean[]{f, f, f, t, t, t, t, t}, 4);
        addSegment(SegmentType.ROOM_CORNER, 2, 1, new boolean[]{f, f, f, t, t, t, f, f}, 4);
        addSegment(SegmentType.ROOM_INNER, 2, 2, new boolean[]{t, t, t, t, t, t, t, t}, 1);
        addSegment(SegmentType.ROOM_DOOR, 2, 3, new boolean[]{f, t, f, t, t, t, t, t}, 4);
        addSegment(SegmentType.ROOM_DOOR_CORNER1, 2, 4, new boolean[]{f, t, f, t, t, t, f, f}, 4);
        addSegment(SegmentType.ROOM_DOOR_CORNER2, 2, 5, new boolean[]{f, f, f, t, t, t, f, t}, 4);
        addSegment(SegmentType.ROOM_DOOR_CORNER_DOUBLE, 2, 6, new boolean[]{f, t, f, t, t, t, f, t}, 4);

        addSegment(SegmentType.FOUNDATION, 3, 0, 1);
        addSegment(SegmentType.PILLARS, 3, 1, 1);
    }

    private static void addSegment(SegmentType type, int row, int col, boolean[] pattern, int rotations) {
        templateSegments.put(type, new TemplateSegment(type, row, col, 1).setPattern(pattern, rotations));
    }

    private static void addSegment(SegmentType type, int row, int col, int sizeY) {
        templateSegments.put(type, new TemplateSegment(type, row, col, sizeY).setMatch(false));
    }
