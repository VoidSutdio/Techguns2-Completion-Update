...
public class AlienBugNest {
    ...
    static class BugNestSegment {
        ...
        ArrayList<BugNestSegment> neighbors = new ArrayList<>(); //one-directional list of connected segments;
    ...
    static class MBlockSlime extends MBlock {
        ...
        private void placeSlimeAt(World world, MutableBlockPos pos) {
            if (world.isAirBlock(pos) && TGBlocks.SLIMY_LADDER.canPlaceBlockAt(world, pos)) {
