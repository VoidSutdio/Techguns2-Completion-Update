...
public class TGuns implements ITGInitializer {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        tfg = new GenericGunCharge("tfg", TFG_PROJECTILES, false, 5, 20, 45, 70.0f, TGSounds.TFG_FIRE, TGSounds.BIOGUN_RELOAD, 100, 0.015f, 60.0f, 10).setChargeSound(TGSounds.TFG_CHARGE).setChargeFX("TFGChargeStart", -0.14f, -0.10f, 0.42f).setBulletSpeed(6.0f).setRangeTooltipType(RangeTooltipType.RADIUS).setPenetration(PENETRATION_MED_HIGH).setTexture("textures/guns/tfg").setAIStats(RANGE_SHORT, 30, 0, 0).setDamageDrop(8, 15, 30.0f).setMuzzleLight(0.2f, 1.0f, 0.2f).setMuzzleFlashTime(10).setRecoiltime(10).setForwardOffset(0.40f).setCrossHair(EnumCrosshairStyle.TRI_INV);
