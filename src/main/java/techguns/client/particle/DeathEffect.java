...
//		
        ...
        genericGore = (new GoreData(modelBiped, 160, 21, 31)).setTexture(new ResourceLocation(Tags.MOD_ID, "textures/entity/gore.png"));
    ...
    public static void postInit() {
        goreStats.values().forEach(GoreData::init);
        genericGore.init();
    }
        ...
        if (deathtype == DeathType.GORE) {
            ...
            try {
                if (data.model == null && render != null) {
                    ModelBase mainModel = (ModelBase) DeathEffectEntityRenderer.RLB_mainModel.get(render);
            ...
            ClientProxy.get().createFX("biodeath", entity.world, x, y, z, motionX, motionY, motionZ);
            ...
            ClientProxy.get().createFX("laserdeathFire", entity.world, x, y, z, motionX, 0, motionZ);
            ClientProxy.get().createFX("laserdeathAsh", entity.world, x, y, z, motionX, 0, motionZ);
