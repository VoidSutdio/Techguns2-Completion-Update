...
public class TGFX {
    ...
    public static List<TGParticleSystem> createFX(World world, String fx, double posX, double posY, double posZ, double motionX, double motionY, double motionZ) {
        if (FXList.containsKey(fx.toLowerCase())) {
            ...
            return fxtype.createParticleSystems(world, posX, posY, posZ, motionX, motionY, motionZ);
        } else {
            return null;
        }
    }
    ...
    public static void loadFXListFile(String filename) {
        ...
        try {
            while (sc.hasNextLine()) {
                ...
                //FXList
                if (next.equalsIgnoreCase("fxlist") && sc.hasNext()) {
                    String name = sc.next();
