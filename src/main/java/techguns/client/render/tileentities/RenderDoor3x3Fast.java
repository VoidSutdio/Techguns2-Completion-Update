...
public class RenderDoor3x3Fast extends FastTESR<Door3x3TileEntity> {
    ...
    protected static final ResourceLocation door_left_loc = new ResourceLocation(Tags.MOD_ID, "block/techdoor3x3_left");
    protected static final ResourceLocation door_right_loc = new ResourceLocation(Tags.MOD_ID, "block/techdoor3x3_right");
    protected static final ResourceLocation door_left_loc_nether = new ResourceLocation(Tags.MOD_ID, "block/techdoor3x3_left_nether");
    protected static final ResourceLocation door_right_loc_nether = new ResourceLocation(Tags.MOD_ID, "block/techdoor3x3_right_nether");
    protected static final ResourceLocation hangar_up_mid_loc = new ResourceLocation(Tags.MOD_ID, "block/hangar_door_mid1j");
    protected static final ResourceLocation hangar_up_mid2_loc = new ResourceLocation(Tags.MOD_ID, "block/hangar_door_mid2j");
    protected static final ResourceLocation hangar_up_mid3_loc = new ResourceLocation(Tags.MOD_ID, "block/hangar_door_mid3j");
    protected static final ResourceLocation hangar_up_lower_loc = new ResourceLocation(Tags.MOD_ID, "block/hangar_door_lower.obj");
    protected static final ResourceLocation hangar_down_upper_loc = new ResourceLocation(Tags.MOD_ID, "block/hangar_door_down_upper.obj");


    public static IBakedModel loadBakedModel(ResourceLocation model_loc, IModelState transform) {
        IModel model = ModelLoaderRegistry.getModelOrLogError(model_loc, "Could not load model:" + model_loc);
        return model.bake(transform, DefaultVertexFormats.ITEM, ModelLoader.defaultTextureGetter());
    }
    ...
    public static void stitchTextures(TextureMap map) {
        map.registerSprite(new ResourceLocation(Tags.MOD_ID, "blocks/techdoor3x3"));
        map.registerSprite(new ResourceLocation(Tags.MOD_ID, "blocks/hangar_door"));
    }
    ...
    @Override
    public void renderTileEntityFast(@NotNull Door3x3TileEntity te, double x, double y, double z, float partialTicks,
                                     int destroyStage, float partial, @NotNull BufferBuilder buffer) {
