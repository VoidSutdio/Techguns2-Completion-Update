...
public class RenderTurret extends TileEntitySpecialRenderer<TurretTileEnt> {
    ...
    protected static final ResourceLocation defaultTexture = new ResourceLocation(Tags.MOD_ID, "textures/blocks/turret_base.png");
    ...
    @Override
    public void render(@NotNull TurretTileEnt te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        if (destroyStage >= 0) {
