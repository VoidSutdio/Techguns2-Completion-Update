...
public class RenderFabricator extends TileEntitySpecialRenderer<FabricatorTileEntMaster> {
    ...
    protected ResourceLocation texture = new ResourceLocation(Tags.MOD_ID, "textures/blocks/fabricator.png");

    @Override
    public void render(@NotNull FabricatorTileEntMaster te, double x, double y, double z, float partialTicks, int destroyStage,
                       float alpha) {
